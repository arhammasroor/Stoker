...
// now replace a-tag with link and href -> to
//in a-tag entire page reload again but not in link
            ...
            <nav class="navbar navbar-expand-lg border-bottom sticky-top" style={{backgroundColor: "#fff"}}>
                <div class="container p-2">
                    <Link class="navbar-brand" to="/">
                        <img src='media/images/newlogo.png' alt='logo' style={{width:"20%",marginRight:"4rem"}}/>
                    </Link>
