    ...
    return (
        <div className='container p-5 mt-5'>
            <div className='row text-center'>
                <h1 className='fs-4 text-muted' style={{ marginBottom: "8rem" }}>We pioneered the discount broking model in India.<br></br>
                    Now, we are breaking ground with our technology.</h1>
                

            </div>
            <div className='row p-5 text-muted border-top' style={{lineHeight:"2rem",fontSize:"1.2rem"}}>
